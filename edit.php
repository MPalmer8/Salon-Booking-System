...
$emptycheckmsg = '';
$emptyval = '';
if((empty($_POST['FirstName']) Or empty($_POST['LastName']) Or empty($_POST['Username']) Or empty($_POST['Tel']) Or empty($_POST['EMail']) Or empty($_POST['gender'])) and isset($_POST['update']))   {
    $emptyval = "False";
...
if(($firstnameval == "False") Or ($emailval == "False") Or ($lastnameval == "False") Or ($usernameval == "False")
 Or ($telval == "False") Or ($emptyval == "False")){
    ...
    UserName = '{$username}', Tel = '{$tel}', EMail = '{$email}', gender = '{$gender}'
